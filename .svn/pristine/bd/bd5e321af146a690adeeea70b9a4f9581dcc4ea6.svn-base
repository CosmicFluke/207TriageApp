...
public class Patient implements Serializable {
	...
	/**
	 * True iff this {@code patient} has been seen by a doctor during 
	 * their most recent visit. If {@code Patient} does
	 * not have a most recent visit, true. 
	 */
	...
	public void addVisit (PatientVisit visit) throws 
		...
		System.out.println(this.wasSeen);
		try {
			if (this.hasVisits && !this.getLastVisit().seenByDoctor()){
