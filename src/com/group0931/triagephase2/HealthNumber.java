...
public class HealthNumber implements Serializable {
	...
	/** The health card number of a {@code Patient}. */
	private String healthNumber;
	
	/** The length of a health card number. */
	 ...
	 * @return true iff the given string is a valid health card number, false otherwise.
	 */
